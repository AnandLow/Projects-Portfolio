...
def main():
    ...
    speed_reference = "s3"
    reference_volume = load_images_from_folder(f"\\\\10.0.16.22\\g\\ReconstructionResult\\ScanningSpeedStudy\\WalkerPassM11\\G1\\30\\WalkerPass_M11_il2_{speed_reference}\\CBC\\{deltat_reference}\\revChambolle_295+ Non-Uni_CamByCam 3mm RRID30 iter20 ROF {deltat_reference} -2.4639--1.1825mm sw{sw_reference} z0.011\\reconstruction\\tiff")
    ...
    for d in delta_t:
        for step in stepweight:
            test_volume = load_images_from_folder(
                f"\\\\10.0.16.22\\g\\ReconstructionResult\\ScanningSpeedStudy\\WalkerPassM11\\G1\\30\\WalkerPass_M11_il2_{speed[1]}\\CBC\\{d}\\revChambolle_295+ Non-Uni_CamByCam 3mm RRID30 iter20 ROF {d} -2.4639--1.1825mm sw{step} z0.011\\reconstruction\\tiff")
            ...
            print(f"{counting}   Stepweight: {step}   Delta t: {d}  Speed: {speed[1]} ")
